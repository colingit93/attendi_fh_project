...
urlpatterns = [
    ...
    path('course/<int:user_id>/list', views.courses_list),
    ...
    path('course_session/<int:course_id>/list', views.course_sessions_list),
    path('course_session/create', views.coursesession_form_create),
    path('course_session/<int:pk>/get', views.coursesession_form_get),
    path('course_session/<int:pk>/update', views.coursesession_form_update),
    path('course_session/<int:pk>/delete', views.coursesession_delete),
    path('course_session/options', views.coursesession_option_list),
    ...
    path('attendance_item/<int:user_id>/list', views.attendance_item_list),
    path('attendance_list/<int:session_id>', views.get_session_attendance_list),
